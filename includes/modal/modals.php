        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <!-- Project Details Go Here -->
                <h2 class="text-uppercase">Digicampus</h2>
                <p class="item-intro text-muted">Criação de Website</p>
                <img class="img-fluid d-block mx-auto" src="img/portfolio/campos-maia-full.jpg" alt="">
                <p>A Digicampus é uma iniciativa criada em conjunto pelos advogados Cristiana Maia, Vinicius Ferreira e pelo webmaster Diogo Fagundes para criar e disponibilizar para comercialização conteúdos didáticos sobre direito e internet.</p>
                <p>
                  O site digicampus.com.br se propõe a ser um campus virtual trazendo sistemas de integração com ambientes de aulas virtuais e conteúdos proprietários sobre direito e tecnologia.
                </p>

                <p>A Vila do Site participou ativamente na criação da identidade visual, logo e principalmente no layout e nos sistemas da digicampus.com.br que conta com área para downloads tanto pública quanto privada para os alunos e integrações com sistemas de EAD como o teachable.com e hotmart.com.</p>

                <ul class="list-inline">
                  <li><a href="https://digicampus.com.br/v1/" target="_blank">digicampus.com.br</a></li>
                  <li>Cliente: Digicampus</li>
                  <li>Serviço: Criação de Website</li>
                </ul>
                <button class="btn btn-primary" data-dismiss="modal" type="button">
                  <i class="fas fa-times"></i>
